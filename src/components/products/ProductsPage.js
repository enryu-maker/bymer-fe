...
import { ManufacturingProcessTimeline } from "../shared/ManufacturingProcessTimeline";
...
function BlankCatalogState() {
  return (
    <div className="w-full flex flex-col gap-5">
      <div className="text-center py-5 px-6 border border-dashed border-[#e5e7eb] bg-[#f9fafb]">
        <h4 className="font-title text-lg sm:text-xl font-bold text-[#1c1b1b] uppercase tracking-wide">
          Select a filter to begin
        </h4>
        <p className="font-body text-xs sm:text-sm text-[#4b5563] max-w-md mx-auto mt-2 leading-relaxed">
    ...
    return (
      <div className="min-h-screen flex flex-col bg-white">
        <PageHeroCarousel
          ...
          description="Browse precision-engineered rubber and elastomer components by Product or Customer. Discover custom manufacturing solutions developed for OEMs, Tier-1, Tier-2, and industrial manufacturers across automotive, electrical, EV, infrastructure, switchgear & electrical, and industrial applications."
        />
